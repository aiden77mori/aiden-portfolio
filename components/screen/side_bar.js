...
export default function SideBar(props) {
    ...
    return (
        <>
            <div className={(props.hide ? " translate-x-full " : "") + " absolute transform duration-300 select-none z-40 right-0 top-0 h-full pt-7 w-auto flex flex-col justify-start items-center border-black border-opacity-60 bg-black bg-opacity-50"}>
                {
                    (
